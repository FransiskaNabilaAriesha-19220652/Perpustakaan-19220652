...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Okt 2023 pada 16.12
...
CREATE TABLE `tb_koleksibuku` (
  `id` char(10) NOT NULL,
  `tb_buku_id` varchar(30) NOT NULL,
  `nomor_koleksi` int(5) NOT NULL,
...
CREATE TABLE `tb_peminjaman` (
  ...
  `tb_pengguna_id_peminjaman` int(50) NOT NULL,
  `tb_pengguna_id_pengembalian` int(50) NOT NULL,
  `tb_anggota_id` int(20) NOT NULL,
  `tb_koleksibuku_id` int(20) NOT NULL,
